 ...
 */
inline void md5Update(MD5Context *ctx, const uint8_t *input_buffer, size_t input_len)
{
  uint32_t input[16];
 ...
 */
inline void md5Finalize(MD5Context *ctx)
{
  uint32_t input[16];
  unsigned int offset = ctx->size % 64;
 ...
 */
inline void md5Step(uint32_t *buffer, const uint32_t *input)
{
 ...
 */
inline void md5String(const char *input, uint8_t *result)
{
  MD5Context ctx;
  md5Init(&ctx);
...
inline void md5File(FILE *file, uint8_t *result)
{
